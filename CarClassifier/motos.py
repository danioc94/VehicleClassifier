...
path, dirs, files = next(os.walk("d:/Documents/code/Carga_python_2/train/testMotos/"))
...
def read_my_list2( minId, maxId, folder ):
	...
	for num in range( minId, maxId+1 ):
		...
		filenames.append( "d:/Documents/code/Carga_python_2/" + folder + "/testMotos/" + name_no( num ) + ".jpg" )
...
with tf.Session() as sess:
	saver.restore(sess, './CNN-Motos_Neg')
